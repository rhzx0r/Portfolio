    ...
    <section className="bg-blue-100 px-6 dark:bg-slate-600">
      <div className="max-w-4xl mx-auto py-12">
        ...
        <div className="text-base">
          <p className="border-b-2 md:border-black py-3 text-lg">
          ...
          <p className="border-b-2 md:border-black py-3 text-lg">Trabajo en equipo: Disfruto trabajando en equipo y
