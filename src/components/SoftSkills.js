      ...
      <div className="max-w-4xl mx-auto py-12">
        ...
        <div className="text-base ">
          <p className="border-b-2 border-black dark:border-white mb-2 py-3 text-lg">
            <span className="text-orange-500">Comunicación efectiva:</span> Soy un comunicador efectivo tanto verbal como
          ...
          <p className="border-b-2 border-black dark:border-white mb-2 py-3 text-lg">
          <span className="text-orange-500">Trabajo en equipo:</span> Disfruto trabajando en equipo y
          ...
          <p className="border-b-2 border-black dark:border-white mb-2 py-3 text-lg">
          <span className="text-orange-500">Resolución de problemas:</span> Soy un solucionador de
          ...
          <p className="border-b-2 border-black dark:border-white mb-2 py-3 text-lg">
          <span className="text-orange-500">Adaptabilidad:</span> Soy
